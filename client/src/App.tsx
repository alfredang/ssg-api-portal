        ...
        <>
          ...
          <div className="course-result" style={{ marginTop: 16 }}>
            ...
            <table className="sessions-table">
              ...
              <tbody>
                <tr><td>Retrieve Trainer Details</td><td>Certificate</td><td>GET</td><td>api.ssg-wsg.sg/trainingProviders/&#123;uen&#125;/trainers</td><td>v2.0</td><td style={{ color: '#d32f2f', fontWeight: 600 }}>403</td><td>Access to this API has been disallowed</td></tr>
                <tr><td>Retrieve Trainer Details</td><td>OAuth</td><td>GET</td><td>public-api.ssg-wsg.sg/trainingProviders/&#123;uen&#125;/trainers</td><td>v2.0</td><td style={{ color: '#d32f2f', fontWeight: 600 }}>403</td><td>Access to this API has been disallowed</td></tr>
                <tr><td>Update/Delete Trainer</td><td>Certificate</td><td>POST</td><td>api.ssg-wsg.sg/trainingProviders/&#123;uen&#125;/trainers/&#123;trainerId&#125;</td><td>v2.0</td><td style={{ color: '#d32f2f', fontWeight: 600 }}>400</td><td>Unable to perform decryption due invalid request (may need AES encryption)</td></tr>
                ...
                <tr><td>Popular Courses</td><td>Certificate</td><td>GET</td><td>api.ssg-wsg.sg/courses/directory/popular</td><td>v2.0</td><td style={{ color: '#d32f2f', fontWeight: 600 }}>403</td><td>Access to this API has been disallowed</td></tr>
                ...
                <tr><td>Course Sessions</td><td>Certificate</td><td>GET</td><td>api.ssg-wsg.sg/courses/runs/&#123;runId&#125;/sessions</td><td>v1.5</td><td style={{ color: '#d32f2f', fontWeight: 600 }}>403</td><td>Access to this API has been disallowed</td></tr>
                <tr><td>Course Sessions</td><td>OAuth</td><td>GET</td><td>public-api.ssg-wsg.sg/courses/runs/&#123;runId&#125;/sessions</td><td>v1.5</td><td style={{ color: '#666' }}>Varies</td><td>Falls back from cert — response varies</td></tr>
                <tr><td>Session Attendance</td><td>Certificate</td><td>GET</td><td>api.ssg-wsg.sg/courses/runs/&#123;runId&#125;/sessions/attendance</td><td>v1.5</td><td style={{ color: '#d32f2f', fontWeight: 600 }}>403</td><td>Access to this API has been disallowed</td></tr>
                <tr><td>Session Attendance</td><td>OAuth</td><td>GET</td><td>public-api.ssg-wsg.sg/courses/runs/&#123;runId&#125;/sessions/attendance</td><td>v1.5</td><td style={{ color: '#666' }}>Varies</td><td>Falls back from cert — response varies</td></tr>
                ...
                <tr><td>Course Lookup</td><td>Certificate</td><td>GET</td><td>api.ssg-wsg.sg/courses/directory/&#123;refNo&#125;</td><td>v1.2</td><td style={{ color: '#d32f2f', fontWeight: 600 }}>403</td><td>Access to this API has been disallowed (OAuth fallback works)</td></tr>
                <tr><td>Course Runs by Ref No</td><td>Certificate</td><td>GET</td><td>api.ssg-wsg.sg/courses/courseRuns/reference</td><td>v1.0</td><td style={{ color: '#d32f2f', fontWeight: 600 }}>403</td><td>Access to this API has been disallowed</td></tr>
                <tr><td>Course Runs by Ref No</td><td>OAuth</td><td>GET</td><td>public-api.ssg-wsg.sg/courses/courseRuns/reference</td><td>v1.0</td><td style={{ color: '#d32f2f', fontWeight: 600 }}>403</td><td>Access to this API has been disallowed</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="course-result" style={{ marginTop: 16 }}>
            ...
            <table className="sessions-table">
              ...
              <tbody>
                ...
                <tr><td style={{ fontWeight: 600 }}>500</td><td>Internal Server Error</td><td>SSG server-side issue or unexpected request format</td></tr>
              </tbody>
            </table>
          </div>
        </>
